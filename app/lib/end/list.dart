import 'package:app/end/musicplayer.dart';
...
class TrackWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemCount: mosPopular.length,
      shrinkWrap: true,
      scrollDirection: Axis.horizontal,
      itemBuilder: (BuildContext context, int index) {
        return GestureDetector(
          onTap: () {
            currentSong = mosPopular[index];
            currentSlider = 0;
            notifyParent();
          },
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: mosPopular[index].color,
                      blurRadius: 1,
                      spreadRadius: 0.3)
                ],
                image: DecorationImage(
                    image: AssetImage(mosPopular[index].image),
                    fit: BoxFit.cover)),
            child: Padding(
              padding: EdgeInsets.all(8),
              child: Column(
